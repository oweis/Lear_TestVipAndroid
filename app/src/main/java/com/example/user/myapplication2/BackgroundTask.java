...
/*
            AdaptWires adaptWires = new AdaptWires();
         //   wires = adaptWires.updateWiresList();
            wires = adaptWires.fireSplices(arrayListWire);
*/
            MySingleton.getInstance(context).addToRequestQueue(jsonArrayRequest);


            //TODO dik sa3a 7yed hadchi mn hna wzidu f activity_wires ra aykhl9u problem
            //TODO zdt had code hna bach mayb9ach yrud splices yb9a yrud direct wires m9adin
